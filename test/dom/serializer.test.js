...
describe('XML Serializer', () => {
  it('supports text node containing "]]>"', () => {
    ...
    assert.strictEqual(doc.documentElement.firstChild.toString(), 'hello ]]> there');
  })
  ...
  it('supports <script> element with no children', () => {
    ...
    assert.strictEqual(doc.documentElement.firstChild.toString(), '<script xmlns="http://www.w3.org/1999/xhtml"></script>');
  })
})
