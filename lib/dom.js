 ...
 * {@link https://www.w3.org/TR/DOM-Level-3-Core/glossary.html#dt-partially-valid "partial validity"}, this exception would be
 * raised and the operation would not be done. This code is used in
 * {@link https://www.w3.org/TR/DOM-Level-3-Core/references.html#DOMVal DOM Level 3 Validation}. Refer to this specification for
 * further information.
 *
 * @since DOM Level 3
 * @type {number}
...
/**
 * Well-formed constraint: No < in Attribute Values> The replacement text of any entity referred to directly or indirectly in an attribute value must not contain a <.
 *
