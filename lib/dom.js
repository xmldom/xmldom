 ...
 * {@link DOMString} values, without defining or constraining how this collection is
 * implemented. The items in the DOMStringList are accessible via an integral index, starting
 * from 0.
 *
 * @typedef {Object} DOMStringList
 * @property {number} length
 * - The number of {@link DOMString DOMStrings} in the list. The range of valid child node
 ...
 * @returns {DOMString | null} The {@link DOMString} at the indexth position in the
 ...
 * of {@link DOMString DOMStrings} in the list, this returns null.
 */
/**
 * The NameList interface provides the abstraction of an ordered collection of parallel pairs
 * of name and namespace values (which could be null values), without defining or constraining
 * how this collection is implemented. The items in the NameList are accessible via an integral
 * index, starting from 0.
 *
 * @typedef {Object} NameList
 * @property {number} length
 ...
 * @param {number} index
 * - Index into the collection.
 * @returns {DOMString | null} The name at the indexth position in the NameList, or null if
 *                             there is no name for the specified index or if the index is out
 *                             of range.
 ...
 * @param {number} index
 * - Index into the collection.
 * @returns {DOMString | null} The namespace URI at the indexth position in the NameList, or
 *                             null if there is no name for the specified index or if the index
 *                             is out of range.
 * @name NameList#getNamespaceURI
 * Returns the indexth namespaceURI item in the collection.
 */
/**
 * The DOMImplementationList interface provides the abstraction of an ordered collection of DOM
 * implementations, without defining or constraining how this collection is implemented. The
 * items in the DOMImplementationList are accessible via an integral index, starting from 0.
 *
 * @typedef {Object} DOMImplementationList
 * @property {number} length
 * - The number of {@link DOMImplementation DOMImplementations} in the list. The range of valid
 ...
 * @param {number} index
 * - Index into the collection.
 * @returns {DOMImplementation | null} The {@link DOMImplementation} at the indexth position in
 *                                     the DOMImplementationList, or null if that is not a
 *                                     valid index.
 * @name DOMImplementationList#item
 * Returns the indexth item in the collection. If index is greater than or equal to the number
 * of {@link DOMImplementation DOMImplementations} in the list, this returns null.
 */
/**
 * This interface permits a DOM implementer to supply one or more implementations, based upon
 * requested features and versions, as specified in
 * {@link https://www.w3.org/TR/DOM-Level-3-Core/core.html#DOMFeatures DOM Features}. Each
 * implemented DOMImplementationSource object is listed in the binding-specific list of
 * available sources so that its
 * {@link https://www.w3.org/TR/DOM-Level-3-Core/core.html#ID-102161490 DOMImplementation}
 * objects are made available.
 *
 * @typedef {Object} DOMImplementationSource
 * @since DOM
 * Level 3.
 */
/**
 * @function
 * @param {DOMString} features
 * - A string that specifies which features and versions are required. This is a space
 * separated list in which each feature is specified by its name optionally followed by a space
 * and a version number. This method returns the first item of the list returned by
 * getDOMImplementationList. As an example, the string "XML 3.0 Traversal +Events 2.0" will
 * request a DOM implementation that supports the module "XML" for its 3.0 version, a module
 * that support of the "Traversal"
 * module for any version, and the module "Events" for its 2.0 version. The module "Events"
 * must be accessible using the method {@link Node#getFeature} and
 * {@link DOMImplementation#getFeature}.
 * @returns {DOMImplementation | null} The first DOM implementation that support the desired
 ...
 * @function
 * @param {DOMString} features
 * A string that specifies which features and versions are required. This is a space separated
 * list in which each feature is specified by its name optionally followed by a space and a
 * version number. This is something like: "XML 3.0 Traversal +Events 2.0"
 * @returns {DOMImplementationList} A list of DOM implementations that support the desired
 *                                  features.
...
/**
 * If a {@link Node} is used in a different document than the one that created it (that doesn't
 * support it).
 *
 * @type {number}
 */
...
/**
 * If a call to a method such as insertBefore or removeChild would make the {@link Node}
 * invalid with respect to
 * {@link https://www.w3.org/TR/DOM-Level-3-Core/glossary.html#dt-partially-valid "partial
 * validity"},
 * this exception would be raised and the operation would not be done. This code is used in
 * {@link https://www.w3.org/TR/DOM-Level-3-Core/references.html#DOMVal DOM Level 3
 * Validation}.
...
DOMImplementation.prototype = {
	 ...
	 * @param {DOMString | null} namespaceURI
	 ...
	 * @param {DOMString | null} qualifiedName
	 ...
	 * `null`
	 * @returns {Document} A new {@link Document} object with its document element. If the
	 *                     NamespaceURI, qualifiedName, and doctype are null, the returned
	 *                     {@link Document} is empty with no document element.
	 * @throws {DOMException}
	 * With code:
	 *
	 ...
	 *
	 * - `publicId` and `systemId` contain the raw data including any possible quotes, so they can
	 * always be serialized back to the original value - `internalSubset` contains the raw string
	 * between `[` and `]` if present, but is not parsed or validated in any form.
	 *
	 * @function DOMImplementation#createDocumentType
	 * @param {DOMString} qualifiedName
	 * The {@link https://www.w3.org/TR/DOM-Level-3-Core/glossary.html#dt-qualifiedname qualified
	 * name} of the document type to be created.
	 * @param {DOMString} [publicId]
	 * The external subset public identifier.
	 * @param {DOMString} [systemId]
	 * The external subset system identifier.
	 * @param {string} [internalSubset]
	 * (from DOM Level 2 Core)
	 * @returns {DocumentType} A new {@link DocumentType} node with {@link Node#ownerDocument} set
	 *                         to null.
	 * @throws {DOMException}
	 * With code:
	 *
	 ...
	 * @see https://www.w3.org/TR/DOM-Level-3-Core/core.html#Level-2-Core-DOM-createDocType DOM
	 *      Level 3 Core
	 * @todo
	 * - There is no `internalSubset` parameter in the specs - Validate qualifiedName using
	 * grammar.
	 */
