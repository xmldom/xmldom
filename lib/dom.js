 ...
 * The DOMStringList interface provides the abstraction of an ordered collection of {@link DOMString} values, without defining or constraining how this collection is implemented. The items in the DOMStringList are accessible via an integral index, starting from 0.
 * @property {number} length - The number of {@link DOMString DOMStrings} in the list. The range of valid child node indices is 0 to length-1 inclusive.
 * @since DOM Level 3
 */
/**
 * @function
 ...
 * Returns the indexth item in the collection. If index is greater than or equal to the number of {@link DOMString DOMStrings} in the list, this returns null.
 * @param {number} index - Index into the collection.
 * @returns {DOMString|null} The {@link DOMString} at the indexth position in the DOMStringList, or null if that is not a valid index.
 */
 ...
 * @param {number} code An integer indicating the type of error generated. See {@link https://www.w3.org/TR/DOM-Level-3-Core/core.html#ID-258A00AF ExceptionCode}
