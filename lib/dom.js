 ...
 * @returns {boolean} Returns `true` if the input string is not empty, `false` otherwise.
 */
 ...
 * @returns {string[]} An array of the split strings. The array can be empty if the input
 *                     string is empty or only contains whitespace characters.
 ...
 * @returns {Record<string, boolean | undefined>} The updated record object after the addition
 *                                                of the new element.
 */
 ...
 * @returns {string[]} An array of unique strings obtained from the input, preserving the
 *                     original order.
 *                     The array can be empty if the input string is empty or only contains
 ...
 * @returns {function(any): boolean} A function that accepts an element and returns a boolean
 *                                   indicating whether the element is included in the provided
 *                                   list.
 */
 ...
 * @todo
 * This function does not fully implement the validation critera from the WHATWG DOM spec.
 */
 ...
 * @param {string} qualifiedName
 * The qualified name to be validated.
 * @returns {[namespace: string | null, prefix: string | null, localName: string]} Returns a
 *                                                                                 tuple with
 *                                                                                 the
 *                                                                                 namespace,
 *                                                                                 prefix and
 ...
 * @returns {Node[]} The array of nodes representing the parent chain from the root to the
 *                   specified node.
 */
 ...
 * @returns {Node} The common ancestor node if it exists. If there is no common ancestor, the
 ...
 * @returns {string} The unique identifier of the document. If the document already had a
 *                   unique identifier, the function will return the existing one.
 */
 ...
 * @todo
 * This does not conform to the living standard:
