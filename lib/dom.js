...
function _insertBefore(parent, node, child, _inDocumentAssertion) {
	...
	if (node.nodeType === DOCUMENT_FRAGMENT_NODE) {
		// Clear the DocumentFragment completely
		node.firstChild = node.lastChild = null;
		node.childNodes.length = 0;
		// Update parent's childNodes to reflect the actual children, not the fragment
...
function importNode(doc,node,deep){
	...
	// Ensure all nodes in the imported tree have the correct ownerDocument
	_updateOwnerDocument(node2, doc);
	return node2;
}
//
