...
function _experimentalDoctypeRegex(source, start) {
	...
	var regex =
		/<!DOCTYPE\s+(([:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]|[\uD800-\uDB7F\uDC00-\uDFFF])([:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-\.0-9\u00B7\u0300-\u036F\u203F-\u2040]|[\uD800-\uDB7F\uDC00-\uDFFF])*)(\s+(SYSTEM)\s+("[^"]*"|'[^']*')|\s+(PUBLIC)\s+("[\r\n\x20\w\-'()+,.\/:=?;!*#@$_%]*"|'[\r\n\x20\w\-()+,.\/:=?;!*#@$_%]*')\s+("[^"]*"|'[^']*'))?\s*(\[((\s*(%(([:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]|[\uD800-\uDB7F\uDC00-\uDFFF])([:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-\.0-9\u00B7\u0300-\u036F\u203F-\u2040]|[\uD800-\uDB7F\uDC00-\uDFFF])*);|<!ELEMENT ([^>]*)>|<!ATTLIST ([^>]*)>|<!ENTITY ([^>]*)>|<!NOTATION ([^>]*)>|<\?([^>]*)\?>|<!--([^>]*)-->)\s*)*)])?\s*>/;
	...
	return {
		name: match[1],
		systemId: match[6] || match[9],
		publicId: match[8],
		internalSubset: match[11],
