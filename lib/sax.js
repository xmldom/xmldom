		...
		try {
			...
			switch (source.charAt(tagStart + 1)) {
				case '/':
					...
					var currentTagName = domBuilder.currentElement.tagName || domBuilder.doc.documentElement.tagName;
					if (currentTagName !== tagNameMatch[1]) {
						if (!isHTML || currentTagName.toLowerCase() !== tagNameMatch[1].toLowerCase()) {
