 ...
 * Currently used for checks in `Document`, `Node`, `Attr`, `Element`, `Text` so the constructor can't be used from outside the module.
 */
var INTERNAL_SYMBOL = Symbol("@xmldom/xmldom");
