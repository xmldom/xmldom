...
/**
 * Normalizes line ending according to [https://www.w3.org/TR/xml11/#sec-line-ends](https://www.w3.org/TR/xml11/#sec-line-ends):> XML parsed entities are often stored in computer files which, for editing convenience, are organized into lines. These lines
 * > are typically separated by some combination of the characters CARRIAGE RETURN (#xD) and LINE FEED (#xA).
 *
 ...
 * > entities (including the document entity) on input, before parsing, by translating all of the following to a single #xA
 * > character:
 *
